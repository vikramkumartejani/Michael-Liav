...
export default function Navbar() {
  ...
  const navLinks = [
    ...
    { href: "/articles", label: "Articles", icon: <FaFileAlt className="text-xl" /> },
        ...
        <div className="max-w-[1440px] mx-auto flex items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <Link href="/" className="group relative z-50">
            <div className="flex items-center space-x-3">
              ...
              <span className={`text-2xl md:text-3xl font-extrabold tracking-wide transition-all duration-300
                ${scrolled ? "text-textPrimary dark:text-lightTextPrimary" : "text-white dark:text-lightTextPrimary"}
                  ...
                  {navLinks.map((link, index) => (
                    ...
                    >
                      ...
                      >
                        ...
                        <FaChevronRight className={`transition-transform ${activeLink === link.href ? "text-highlight dark:text-lightHighlight" : ""}`} />
                      </Link>
                    </motion.li>
                  ))}
                </ul>
