...
export default function Contact() {
  ...
  return (
    <div className="relative min-h-screen py-12 sm:py-16 md:py-20  text-white transition-colors duration-300 dark:bg-lightPrimary dark:text-lightTextPrimary overflow-hidden">
      ...
      <div className="max-w-[1400px] w-full mx-auto px-4 sm:px-6">
        ...
        >
          ...
          >
            ...
            >
              Whether you're looking for collaboration, advice, or just want to
              say hi, I'm always happy to connect. Feel free to reach out to me
              directly.
            </motion.p>
          </motion.div>
            ...
            >
              ...
              >
                ...
                <p className="text-sm sm:text-base text-textSecondary dark:text-lightTextSecondary">
                  ...
                  collaborations, and consulting work. My typical response time
                ...
                {formSubmitted ? (
                  ...
                  >
                    ...
                    <motion.button
                      ...
                      whileTap="tap"
                      style={{ backgroundColor: theme.accent }}
                      className="w-full py-2.5 sm:py-3 px-4 sm:px-6  text-white rounded-lg font-medium flex items-center justify-center space-x-2 text-sm sm:text-base"
                    >
      ...
      <div className="hidden sm:block">
        <motion.div
          style={{ color: theme.accent }}
          className="absolute top-1/4 left-10 w-4 h-4 rounded-full  opacity-70"
